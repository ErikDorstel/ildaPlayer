...
void doDogfight() {
  ...
  if (ship1.posX>31000) { ship1.posX=31000; }
  else if (ship1.posX<-31000) { ship1.posX=-31000; }
  if (ship1.posY>31000) { ship1.posY=31000; }
  else if (ship1.posY<-31000) { ship1.posY=-31000; }
  if (adc1.y>500) { doObject(shipEngineData,ship1.posX,ship1.posY,ship1.turn); }
  ...
  if (ship2.posX>31000) { ship2.posX=31000; }
  else if (ship2.posX<-31000) { ship2.posX=-31000; }
  if (ship2.posY>31000) { ship2.posY=31000; }
  else if (ship2.posY<-31000) { ship2.posY=-31000; }
  if (adc2.y>500) { doObject(shipEngineData,ship2.posX,ship2.posY,ship2.turn); }
  ...
  for (int n=0;n<20;n++) { if (phaser1[n].throttle) {
    ...
    if (phaser1[n].posX>4850 && phaser1[n].posX<5150) {
    ...
    else if (phaser1[n].posX<-30000) { phaser1[n].throttle=0; }
    if (phaser1[n].posY>30000) { phaser1[n].throttle=0; }
    else if (phaser1[n].posY<-30000) { phaser1[n].throttle=0; } } }
  ...
  for (int n=0;n<20;n++) { if (phaser2[n].throttle) {
    ...
    if (phaser2[n].posX>4850 && phaser2[n].posX<5150) {
    ...
    else if (phaser2[n].posX<-30000) { phaser2[n].throttle=0; }
    if (phaser2[n].posY>30000) { phaser2[n].throttle=0; }
    else if (phaser2[n].posY<-30000) { phaser2[n].throttle=0; } } }
